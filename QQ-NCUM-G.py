...
qq_plot(ncum_r1_data, obs_data, "NCUM G-Day1 vs Observation", axes[0])
qq_plot(ncum_r2_data, obs_data, "NCUM G-Day2 vs Observation", axes[1])
qq_plot(ncum_r3_data, obs_data, "NCUM G-Day3 vs Observation", axes[2])
