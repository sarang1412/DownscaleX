...
hex_colors = ['#64fffc','#9364ff00','#ff01fe']
...
ax1.text(0.02, 0.95, 'Very Heavy', transform=ax1.transAxes, fontsize=10, verticalalignment='top', color='blue')
ax1.text(0.02, 0.90, 'No Rain', transform=ax1.transAxes, fontsize=10, verticalalignment='top', color='green')
ax1.text(0.02, 0.85, 'Extremely Heavy', transform=ax1.transAxes, fontsize=10, verticalalignment='top', color='red')
...
ax2.text(0.02, 0.95, 'Very Heavy', transform=ax2.transAxes, fontsize=10, verticalalignment='top', color='blue')
ax2.text(0.02, 0.90, 'No Rain', transform=ax2.transAxes, fontsize=10, verticalalignment='top', color='green')
ax2.text(0.02, 0.85, 'Extremely Heavy', transform=ax2.transAxes, fontsize=10, verticalalignment='top', color='red')
...
ax3.text(0.02, 0.95, 'Very Heavy', transform=ax3.transAxes, fontsize=10, verticalalignment='top', color='blue')
ax3.text(0.02, 0.90, 'No Rain', transform=ax3.transAxes, fontsize=10, verticalalignment='top', color='green')
ax3.text(0.02, 0.85, 'Extremely Heavy', transform=ax3.transAxes, fontsize=10, verticalalignment='top', color='red')
...
ax4.text(0.02, 0.95, 'Very Heavy', transform=ax4.transAxes, fontsize=10, verticalalignment='top', color='blue')
ax4.text(0.02, 0.90, 'No Rain', transform=ax4.transAxes, fontsize=10, verticalalignment='top', color='green')
ax4.text(0.02, 0.85, 'Extremely Heavy', transform=ax4.transAxes, fontsize=10, verticalalignment='top', color='red')
...
ax2.add_feature(cfeature.COASTLINE, linewidth=0.5)
shape.boundary.plot(ax=ax2, edgecolor='black', linewidth=0.7, transform=ccrs.PlateCarree())
ax2.set_title('Rainfall Intensity - NCUM-G Day 1', fontsize=12)
...
ax3.add_feature(cfeature.COASTLINE, linewidth=0.5)
shape.boundary.plot(ax=ax3, edgecolor='black', linewidth=0.7, transform=ccrs.PlateCarree())
ax3.set_title('Rainfall Intensity - NCUM-G Day 2', fontsize=12)
...
ax4.add_feature(cfeature.COASTLINE, linewidth=0.5)
shape.boundary.plot(ax=ax4, edgecolor='black', linewidth=0.7, transform=ccrs.PlateCarree())
ax4.set_title('Rainfall Intensity - NCUM-G Day 3', fontsize=12)
