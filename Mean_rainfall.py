...
ncum_g_1_mean['APCP_surface'].plot(ax=ax2, cmap=hexa, transform=ccrs.PlateCarree(), cbar_kwargs={'label': 'mean rainfall(mm/day)', 'shrink': 0.9}, vmin=0, vmax=52)
...
ncum_g_2_mean['APCP_surface'].plot(ax=ax3, cmap=hexa, transform=ccrs.PlateCarree(), cbar_kwargs={'label': 'mean rainfall(mm/day)', 'shrink': 0.9}, vmin=0, vmax=52)
...
ncum_g_3_mean['APCP_surface'].plot(ax=ax4, cmap=hexa, transform=ccrs.PlateCarree(), cbar_kwargs={'label': 'mean rainfall(mm/day)', 'shrink': 0.9}, vmin=0, vmax=52)
